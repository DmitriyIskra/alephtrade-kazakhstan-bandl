...
;// ./src/js/slider-brands/sliderBrands.js
function sliderBrands(Swiper, slider, modules) {
...
;// ./src/js/slider-banners/sliderBanners.js
function sliderBanners(Swiper, slider, modules) {
...
;// ./src/js/burger-menu/ControllBurger.js
class ControllBurger {
    constructor(d) {
        this.d = d;
...
;// ./src/js/burger-menu/RedrawBurger.js
class RedrawBurger {
...
;// ./src/js/callback/ControllCallback.js
class ControllCallback {
    constructor(d, api) {
        this.d = d;
        this.api = api;
...
;// ./src/js/callback/RedrawCallback.js
...
;// ./src/js/callback/ApiCallback.js
class ApiCallback {
    async create(data) {
        try {
...
// Форма обратной связи
const app_form = document.querySelector('.callback__form');
if(app_form) {
    ...
    const redraw = new RedrawCallback(app_form, coverCloseLink, closeButton);
